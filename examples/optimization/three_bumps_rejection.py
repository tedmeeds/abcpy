...
from abcpy.problems.optimization.three_bumps import *
...
problem_params["noise"] = 0.05
problem_params["prior_mu"] = 0
problem_params["prior_std"] = 1
problem_params["q_stddev"] = 0.75
problem = ThreeBumpsProblem( problem_params, force_init = True )
...
problem.view_results( recorder, burnin = 0, epsilon = problem_params["epsilon"] )
print "***************  DONE VIEW    ***************"
pp.show()
