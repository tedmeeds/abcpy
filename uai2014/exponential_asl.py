...
for S in Ss:
  ...
  if state_params["is_marginal"]:
    save_dir = "./uai2014/runs/exponential/asl_marginal_s%d_ds%d/"%(state_params["S"],model_params["deltaS"])
  else:
    save_dir = "./uai2014/runs/exponential/asl_pseudo_s%d_ds%d/"%(state_params["S"],model_params["deltaS"])
  ...
  for xi in xis:
    ...
    for repeat in range(repeats):
      ...
      out_name = save_dir + epsilon_string + "_" + state_params["hierarchy_type"] + "_" + "repeat%d"%(repeat+1)
